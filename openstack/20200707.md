...
resources: 
  RouterInterface_1: 
    ...
    properties: LinkedIn 같은 경우야 영문이력서로 지원하는게 좀 일반적이지만, 회사 웹사이트 통한 지원은 국문이 아닌 영문이력서로 지원하는 것에 대해서 어떻게 생각하십니까? (edited) 
...
<img src=/img/20200707-2>

* openstack 대시보드에서 RC파일 저장
